...
//    @Override
//    public boolean conclude(int selectedContractId) {
//        int Id = selectedContractId;
...
//    }
    ...
    @Override
    public Contract findByContractId(int selectedContractId) {
        Contract contract = this.contractList.findById(selectedContractId);
        if(contract == null){
            return null;
        } else {
    ...
    @Override
    public Insurance findByInsuranceId(int selectedInsuranceId) {
